...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/contentslider.css"/>" />
<script type="text/javascript" src="<c:url value="/resources/scripts/contentslider.js"/>">
    	...
    	<div id="mid_slider"><span></span>
        	<div id="slider1" class="sliderwrapper">
                ...
                <div class="contentdiv">
                    <img src="<c:url value ="/resources/images/slider/image_03.jpg" /> " alt="Image 00" />
                </div>
    
                <div class="contentdiv">
                    <img src="<c:url value="/resources/images/slider/image_01.jpg" /> " alt="Image 01" />
                </div>            
                
                <div class="contentdiv">
                    <img src="<c:url value ="/resources/images/slider/image_02.jpg" /> " alt="Image 02" />
                </div>
                
                <div class="contentdiv">
                    <img src="<c:url value ="/resources/images/slider/image_03.jpg" /> " alt="Image 03" />
                </div>
        ...
        <div id="templatemo_content">
			...
			<div class="col_allw300">
                ...
                <div class="sb_news_box">
                    <img src="<c:url value ="/resources/images/templatemo_image_05.jpg" />"  alt="Image 05" />
                ...
                <div class="sb_news_box">
                    <img src="<c:url value ="/resources/images/templatemo_image_03.jpg" />" alt="Image 03" />
                ...
                <div class="sb_news_box">
                    <img src="<c:url value ="/resources/images/templatemo_image_04.jpg" />" alt="Image 04" />
                    <div class="news_date">OCT 16, 2048</div>
                    <h6><a href="#">Curabitur scelerisque, in lacinia massa consectetur sit amet.</a></h6>
                    <div class="cleaner"></div>
                </div>
                <div class="sb_news_box">
                    <img src="<c:url value ="/resources/images/templatemo_image_06.jpg" />" alt="Image 06" />
            ...
            <div class="col_allw300 col_last">
                ...
                <div class="fp_lw_box">
                <div class="image_frame"><span></span><img src="<c:url value ="/resources/images/templatemo_image_01.jpg" />" alt="Image 01" /></div
                ><p><em>Morbi sed nulla ac est cursus suscipit ac lectus.</em></p>
				</div>
                <div class="fp_lw_box">
                <div class="image_frame"><span></span><img src="<c:url value ="/resources/images/templatemo_image_02.jpg" />" alt="Image 02" /></div
